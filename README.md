...
It boils down to the GitHub authorization/permissions implementation. The permission given in an Action's run is based on the head branch from which it originates. If a user without read access opens a Pull Request from their fork then it will not be granted adequate permissions to set the labels. See https://github.com/actions/labeler/issues/12, https://github.com/actions/first-interaction/issues/10, and https://github.community/t/github-actions-are-severely-limited-on-prs/18179#M9249 for more information.
