...
- Merge Commits are automatically generated by GitHub, see this [guide](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/about-pull-request-merges) for more information
- _Merge Changes_ are the mistakes that process can generate when it tries to decide how to mix two branches!

↪️ This is best explained by quotes from the internet...

> We were trying to do a big merge, and got unexpected results! [ref](https://stackoverflow.com/q/59542831/8480874)
